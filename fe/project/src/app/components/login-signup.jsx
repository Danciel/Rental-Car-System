            ...
            <div className="w-full lg:w-1/2 h-dvh overflow-hidden flex items-center justify-center bg-gray-50">
                ...
                <div className="w-full max-w-md h-full flex flex-col justify-center px-6 py-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg px-6 py-5 flex flex-col min-h-0 max-h-[72dvh]">
                        ...
                        <div
                            className="min-h-0 flex-1 overflow-auto pr-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className={`w-full text-white py-2.5 rounded-xl font-semibold transition-colors shadow-lg hover:shadow-xl ${
                                        isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#1E40AF] hover:bg-[#1a3699]'
                                    }`}
                                >
